 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.service.example.org/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.example.org/", "HelloServiceImplService");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.service.example.org/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.example.org/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
